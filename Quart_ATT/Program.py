...
customer1 = Customer(1, "Choffer")
customer2 = Customer(2, "Ricardo")
customer3 = Customer(3, "Luva")
customer4 = Customer(4, "Flamengo")
...
product1 = Product(1, "Salgadin", 8.78, 2)
product2 = Product(2, "Biscoito", 11.00, 11)
product3 = Product(3, "Bolacha", 10.23, 9)
product4 = Product(4, "Creme_Crack", 5.98, 6)
